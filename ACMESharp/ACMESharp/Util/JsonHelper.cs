...
namespace ACMESharp.Util {
 public static class JsonHelper {
  ...
  public static void Save ( Stream s, Object obj, Boolean noneOrAuto ) {
   using ( var w = new StreamWriter ( s ) ) {
  ...
  public static String Save ( Object obj, Boolean noneOrAuto ) {
   using ( var ms = new MemoryStream () ) {
  ...
  public class AcmeEntitySerializer : Newtonsoft.Json.JsonConverter {
   ...
   public override Boolean CanConvert ( Type objectType ) => typeof ( ACME.Challenge ).IsAssignableFrom ( objectType )
   ...
   public override Object ReadJson ( JsonReader reader, Type objectType, Object existingValue, JsonSerializer serializer ) {
    if ( typeof ( AcmeServerDirectory ) == objectType ) {
     ...
     if ( jarr == null ) {
      ...
      sdir = sdir ?? new AcmeServerDirectory ();
